...
const ThumbnailUpload = ( {
    ...
    return (
        <>
            <input type="file" 
            ref={fileInputRef} 
            accept={fileType === "video" ? "Please upload an image file" : "image/*"}
            onChange={handleFileChange}
            className="file-input file-input-bordered file-input-primary w-full max-w-xs mb-1"
            />
            ...
            {thumbnailURL && (
              <div>
                ...
                <img src={thumbnailURL} alt="Thumbnail Preview" style={{maxWidth: '200px', marginTop: '10px'}} />
              </div>
            )}
        </>
    );
